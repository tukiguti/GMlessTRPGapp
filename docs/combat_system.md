...
#### ワード配置
- **配置可能エリア**: すべてのマップエリアに配置可能
  - **レーン**: TOPレーン、MIDレーン、BOTレーン
  - **ジャングル**: TOP-MID森（味方陣/敵陣）、MID-BOT森（味方陣/敵陣）
  - **中立エリア**: ドラゴンピット、バロンピット
...
ワードは配置されたエリアとその隣接エリアに視界効果を提供します。

#### 視界効果のレベル

| 配置場所 | 効果レベル | 視界効果 |
|---------|----------|---------|
| **設置エリア** | 最大 | 敵の進入を即座に把握、完全な視界 |
| **隣接エリア** | 少し | 敵の進入を部分的に把握、視界ボーナス減少 |

**例**: BOTレーンにワードを設置
- **BOTレーン**: 完全な視界（最大効果）
- **MID-BOT森（味方陣）**: 少しの視界（隣接エリア）
- **MID-BOT森（敵陣）**: 少しの視界（隣接エリア）
- **ドラゴンピット**: 少しの視界（隣接エリア）
...
- 敵の進入を即座に把握
- ガンクを完全に察知可能
- マッチアップ判定のガンクボーナスを無効化

**隣接エリア（少しの効果）**:
- 敵の大まかな動きを把握
- ガンク時のボーナス+3を+1に減少（-2の効果）
- 完全な視界ではないが、一部の情報を得られる
...
- 敵の大まかな動きを把握
- ガンク時のボーナス+3を+1に減少
- 完全には防げないが、ある程度の対応が可能

#### 視界がない場合
- 敵の進入を把握不可
- ガンクされた際にペナルティ
- **JGとSUPのガンク時に+3ボーナス**（攻撃側有利）
...
**補正の種類**:
- **攻撃力補正**: キャラクターの基本攻撃力（レベル・アイテム・バフで上昇）
- **状況補正**: 視界ボーナス、CCペナルティ、ガンク移動力ボーナス、数的有利ボーナスなど
...
1. 各チームがポジション配置を宣言
   ...
   - バックライン
2. 強制配置ルール
   - ガンクされた側（防御側）は強制的にフロントライン配置
   - ファームを選択したプレイヤーが攻撃された場合、強制的にフロントライン配置
