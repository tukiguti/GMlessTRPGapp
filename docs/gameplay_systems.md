...
#### タワーダメージ計算
- **ファーム時のタワーダメージ（対面なし）**: 固定200ダメージ/ターン
- **攻撃選択時のタワーダメージ（対面あり）**: なし
...
| **対面あり** | ゴールド100G（マッチアップ不参加） | ゴールド50G + マッチアップ判定 + タワーダメージなし |

**重要**:
- タワーを攻撃するには対面がいない状況で「ファーム」を選択する必要があります
- 対面がいる場合、タワーにダメージは入りません

### タワーの攻撃システム

#### タワーの攻撃性能
タワーは射程内の敵に対して自動攻撃を行います：

**基本性能**
- **攻撃力**:
  - 対チャンピオン: **固定150ダメージ/ターン**
  - 対ミニオン: **即死**（ミニオンは1発で破壊される）
- **攻撃速度**: **1ターンに1回攻撃**
- **射程**: タワーの周辺エリア（「タワー下」ポジション）

#### タワーのターゲット優先度

タワーは以下の優先順位で攻撃対象を決定します：

**1. タワーダイブしたチャンピオン（最優先）**
- タワー射程内で敵チャンピオンを攻撃したチャンピオンを最優先で攻撃
- そのチャンピオンがタワー射程外に出るか、倒されるまでターゲットを維持

**2. 敵ミニオン（通常優先）**
- タワーダイブが発生していない場合、ミニオンを優先攻撃
- 最も近いミニオンから順番に攻撃

**3. 射程内のチャンピオン（最終優先）**
- ミニオンがいない場合のみ、射程内のチャンピオンを攻撃
- 最も近いチャンピオンを攻撃

#### ミニオンウェーブとの連携

**ミニオンウェーブの役割**
ミニオンウェーブはタワー攻撃から身を守る盾として機能します：

1. **ウェーブ管理の重要性**
   - ミニオンウェーブが存在する場合、タワーはミニオンを優先攻撃
   - プレイヤーはミニオンの後ろに隠れることで、タワー攻撃を回避可能

2. **タワーダイブのリスク**
   - **ミニオンなしでのタワーダイブ**: 非常に危険（タワー攻撃150ダメージ/ターン）
   - **ミニオンありでのタワーダイブ**: リスク軽減（ただし敵を攻撃した瞬間にタワーターゲット）
   - タワーダイブ中は、タワーから150ダメージを受けながら敵と戦闘

3. **プッシュ（ウェーブ管理）**
   - 敵のミニオンウェーブを早く処理することで、自軍ミニオンがタワーに到達
   - 自軍ミニオンがタワーを攻撃している間は比較的安全にタワーを攻撃可能

4. **タワー下でのファーム**
   - 味方タワーの下は安全地帯（敵がタワーダイブしない限り）
   - ただし、タワーがミニオンを攻撃するため、CSを取るタイミングが難しい

#### タワー攻撃の判定タイミング

**ターンエンド時の処理順序**:
1. プレイヤーの行動解決（マッチアップ判定など）
2. タワー攻撃の判定・実行
3. 位置・状態の更新

**例: タワーダイブのケース**
- プレイヤーAがタワー下でプレイヤーBを攻撃
- マッチアップ判定実行
- ターンエンド時、タワーがプレイヤーAに150ダメージ
- 次のターン開始時、プレイヤーAがまだ射程内にいれば再度150ダメージ
