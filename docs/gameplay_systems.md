...
- **スポーン位置**: 各レーン（TOP/MID/BOT）のレーンエリア
- **ミニオン数**: 各レーンに1体ずつスポーン
- **重要**: ミニオンは沸いた瞬間に、該当するレーンエリアに生まれます。移動時間は不要で、スポーンと同時にレーンエリアに配置されます。

**ミニオンのステータス**
- **HP**: **3**（タワーが3回攻撃で倒せる）
- **移動**: レーンエリア内で敵タワーに向かって進む（エリア間の移動は行わない）
...
## 変更履歴
- 2025-11-11: ミニオンスポーンルールの明確化
  - ミニオンが沸いた瞬間にレーンエリアに生まれることを明記
  - ミニオンの移動ルールを明確化（エリア間の移動は行わない）
